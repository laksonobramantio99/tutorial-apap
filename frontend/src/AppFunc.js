...
*/
function App() {
    // Btw, this is hooks. useState function returns an array contains the state and
    // a function to set the state -> [state, setState]. What you see below is array
    // destruction. Let say you have an array const arr = ["aaa", "bbb"], to access
    // the item we can use index arr[0] OR destruct it like below const [varName,
    // index1] = arr, variable varName is guaranteed to get the value of index 0 OR "aaa"
